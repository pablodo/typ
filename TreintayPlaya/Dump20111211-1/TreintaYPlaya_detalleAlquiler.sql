...
--
-- Table structure for table `detalleAlquiler`
--
...
CREATE TABLE `detalleAlquiler` (
  ...
  `daAlquiler` int(11) DEFAULT NULL,
  `daInicial` date DEFAULT NULL,
  `daFinal` date DEFAULT NULL,
  PRIMARY KEY (`daID`)
...
LOCK TABLES `detalleAlquiler` WRITE;
