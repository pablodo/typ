...
CREATE TABLE `TipoUnidad` (
  ...
  `tuUbicacion` varchar(45) DEFAULT NULL,
  `tuMetros` int(11) DEFAULT NULL,
  `tuNombre` varchar(45) DEFAULT NULL,
  `tuContrato` int(11) DEFAULT NULL,
  `tuAmbientes` int(11) DEFAULT NULL,
  PRIMARY KEY (`tuID`)
