...
CREATE TABLE `Alquileres` (
  ...
  `alqCliente` int(11) DEFAULT NULL,
  `alqPropietario` int(11) DEFAULT NULL,
  `alqUF` int(11) DEFAULT NULL,
  `alqTotal` decimal(8,2) DEFAULT NULL,
  `alqEstado` int(11) DEFAULT NULL,
  PRIMARY KEY (`alqID`)
