...
CREATE TABLE `Clientes` (
  ...
  `cliDNI` varchar(45) NOT NULL,
  `cliApellido` varchar(45) DEFAULT NULL,
  `cliNombre` varchar(45) DEFAULT NULL,
  `cliTelefono` varchar(45) DEFAULT NULL,
  `cliCelular` varchar(45) DEFAULT NULL,
  `cliEmail` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`cliID`),
  UNIQUE KEY `cliDNI_UNIQUE` (`cliDNI`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Base de Clientes.';
